...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT bmp085_init (t_bmp085 *data)
{
    data->oss = 3;
    return SUCCESS;
}
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT bmp085_get_uncompensated_temperature (I2C_BUS i2c_bus_id, t_bmp085 *data)
{
    u8 tmp1, tmp2;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT bmp085_get_uncompensated_pressure (I2C_BUS i2c_bus_id, t_bmp085 *data)
{
    u8 tmp1, tmp2, tmp3;
    u8 cfg=0;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT bmp085_get_calibration_coef (I2C_BUS i2c_bus_id, t_bmp085 *data)
{
    u8 tmp1, tmp2;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT bmp085_calculate_temp_pressure(t_bmp085 *data)
{
