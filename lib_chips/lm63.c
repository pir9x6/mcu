...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT lm63_init (I2C_BUS i2c_bus_id)
{
    u8 tmp[4];
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT lm63_read_temp (I2C_BUS i2c_bus_id, u8 *temp)
{
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT lm63_read_speed(I2C_BUS i2c_bus_id, u16 *speed)
{
    u8 data1=0;
    u8 data2=0;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT lm63_set_fan_speed (I2C_BUS i2c_bus_id, u8 speed)
{
...
//---------------------- Read Fan Speed from LM63 -----------------------------
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
RESULT lm63_update_data (I2C_BUS i2c_bus_id, t_lm63_data *data)
{
    u8 tmp, tmp2;
