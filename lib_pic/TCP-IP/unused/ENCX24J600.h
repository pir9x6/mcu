...
////////////////////////////////////////////////////
// ESTAT bits ----------
#define ESTAT_INT		((u16)1<<15)
#define ESTAT_FCIDLE	((u16)1<<14)
#define ESTAT_RXBUSY	((u16)1<<13)
#define ESTAT_CLKRDY	((u16)1<<12)
#define ESTAT_RSTDONE	((u16)1<<11)
#define ESTAT_PHYDPX	((u16)1<<10)
#define ESTAT_PHYRDY	((u16)1<<9)
#define ESTAT_PHYLNK	((u16)1<<8)
...
// EIR bits ------------
#define EIR_CRYPTEN		((u16)1<<15)
#define EIR_MODEXIF		((u16)1<<14)
#define EIR_HASHIF		((u16)1<<13)
#define EIR_AESIF		((u16)1<<12)
#define EIR_LINKIF		((u16)1<<11)
#define EIR_PRDYIF		((u16)1<<10)
#define EIR_r9			((u16)1<<9)
#define EIR_r8			((u16)1<<8)
#define EIR_r7			(1<<7)
...
// ECON1 bits ----------
#define ECON1_MODEXST	((u16)1<<15)
#define ECON1_HASHEN	((u16)1<<14)
#define ECON1_HASHOP	((u16)1<<13)
#define ECON1_HASHLST	((u16)1<<12)
#define ECON1_AESST		((u16)1<<11)
#define ECON1_AESOP1	((u16)1<<10)
#define ECON1_AESOP0	((u16)1<<9)
#define ECON1_PKTDEC	((u16)1<<8)
...
// ETXSTAT bits --------
#define ETXSTAT_r12		((u16)1<<12)
#define ETXSTAT_r11		((u16)1<<11)
#define ETXSTAT_LATECOL	((u16)1<<10)
#define ETXSTAT_MAXCOL	((u16)1<<9)
#define ETXSTAT_EXDEFER	((u16)1<<8)
...
// ERXFCON bits --------
#define ERXFCON_HTEN	((u16)1<<15)
#define ERXFCON_MPEN	((u16)1<<14)
#define ERXFCON_NOTPM	((u16)1<<12)
#define ERXFCON_PMEN3	((u16)1<<11)
#define ERXFCON_PMEN2	((u16)1<<10)
#define ERXFCON_PMEN1	((u16)1<<9)
#define ERXFCON_PMEN0	((u16)1<<8)
...
// MACON1 bits ---------
#define MACON1_r15		((u16)1<<15)
#define MACON1_r14		((u16)1<<14)
#define MACON1_r11		((u16)1<<11)
#define MACON1_r10		((u16)1<<10)
#define MACON1_r9		((u16)1<<9)
#define MACON1_r8		((u16)1<<8)
...
// MACON2 bits ---------
#define	MACON2_DEFER	((u16)1<<14)
#define	MACON2_BPEN		((u16)1<<13)
#define	MACON2_NOBKOFF	((u16)1<<12)
#define MACON2_r9		((u16)1<<9)
#define MACON2_r8		((u16)1<<8)
...
// MAIPG bits ----------
#define MAIPG_r14		((u16)1<<14)
#define MAIPG_r13		((u16)1<<13)
#define MAIPG_r12		((u16)1<<12)
#define MAIPG_r11		((u16)1<<11)
#define MAIPG_r10		((u16)1<<10)
#define MAIPG_r9		((u16)1<<9)
#define MAIPG_r8		((u16)1<<8)
...
// MACLCON bits --------
#define MACLCON_r13		((u16)1<<13)
#define MACLCON_r12		((u16)1<<12)
#define MACLCON_r11		((u16)1<<11)
#define MACLCON_r10		((u16)1<<10)
#define MACLCON_r9		((u16)1<<9)
#define MACLCON_r8		((u16)1<<8)
...
// MIREGADR bits -------
#define MIREGADR_r12	((u16)1<<12)
#define MIREGADR_r11	((u16)1<<11)
#define MIREGADR_r10	((u16)1<<10)
#define MIREGADR_r9		((u16)1<<9)
#define MIREGADR_r8		((u16)1<<8)
...
// ECON2 bits ----------
#define ECON2_ETHEN		((u16)1<<15)
#define ECON2_STRCH		((u16)1<<14)
#define ECON2_TXMAC		((u16)1<<13)
#define ECON2_SHA1MD5	((u16)1<<12)
#define ECON2_COCON3	((u16)1<<11)
#define ECON2_COCON2	((u16)1<<10)
#define ECON2_COCON1	((u16)1<<9)
#define ECON2_COCON0	((u16)1<<8)
...
// ERXWM bits ----------
#define ERXWM_RXFWM7	((u16)1<<15)
#define ERXWM_RXFWM6	((u16)1<<14)
#define ERXWM_RXFWM5	((u16)1<<13)
#define ERXWM_RXFWM4	((u16)1<<12)
#define ERXWM_RXFWM3	((u16)1<<11)
#define ERXWM_RXFWM2	((u16)1<<10)
#define ERXWM_RXFWM1	((u16)1<<9)
#define ERXWM_RXFWM0	((u16)1<<8)
...
// EIE bits ------------
#define EIE_INTIE		((u16)1<<15)
#define EIE_MODEXIE		((u16)1<<14)
#define EIE_HASHIE		((u16)1<<13)
#define EIE_AESIE		((u16)1<<12)
#define EIE_LINKIE		((u16)1<<11)
#define EIE_PRDYIE		((u16)1<<10)
#define EIE_r9			((u16)1<<9)
#define EIE_r8			((u16)1<<8)
#define EIE_r7			(1<<7)
...
// EIDLED bits ---------
#define EIDLED_LACFG3	((u16)1<<15)
#define EIDLED_LACFG2	((u16)1<<14)
#define EIDLED_LACFG1	((u16)1<<13)
#define EIDLED_LACFG0	((u16)1<<12)
#define EIDLED_LBCFG3	((u16)1<<11)
#define EIDLED_LBCFG2	((u16)1<<10)
#define EIDLED_LBCFG1	((u16)1<<9)
#define EIDLED_LBCFG0	((u16)1<<8)
...
// PHCON1 bits ---------
#define PHCON1_PRST		((u16)1<<15)
#define PHCON1_PLOOPBK	((u16)1<<14)
#define PHCON1_SPD100	((u16)1<<13)
#define PHCON1_ANEN		((u16)1<<12)
#define PHCON1_PSLEEP	((u16)1<<11)
#define PHCON1_r10		((u16)1<<10)
#define PHCON1_RENEG	((u16)1<<9)
#define PHCON1_PFULDPX	((u16)1<<8)
...
// PHSTAT1 bits --------
#define PHSTAT1_r15		((u16)1<<15)
#define PHSTAT1_FULL100	((u16)1<<14)
#define PHSTAT1_HALF100	((u16)1<<13)
#define PHSTAT1_FULL10	((u16)1<<12)
#define PHSTAT1_HALF10	((u16)1<<11)
#define PHSTAT1_r10		((u16)1<<10)
#define PHSTAT1_r9		((u16)1<<9)
#define PHSTAT1_r8		((u16)1<<8)
...
// PHANA bits ----------
#define PHANA_ADNP		((u16)1<<15)
#define PHANA_r14		((u16)1<<14)
#define PHANA_ADFAULT	((u16)1<<13)
#define PHANA_r12		((u16)1<<12)
#define PHANA_ADPAUS1	((u16)1<<11)
#define PHANA_ADPAUS0	((u16)1<<10)
#define PHANA_r9		((u16)1<<9)
#define PHANA_AD100FD	((u16)1<<8)
...
// PHANLPA bits --------
#define PHANLPA_LPNP	((u16)1<<15)
#define PHANLPA_LPACK	((u16)1<<14)
#define PHANLPA_LPFAULT	((u16)1<<13)
#define PHANLPA_r12		((u16)1<<12)
#define PHANLPA_LPPAUS1	((u16)1<<11)
#define PHANLPA_LPPAUS0	((u16)1<<10)
#define PHANLPA_LP100T4	((u16)1<<9)
#define PHANLPA_LP100FD	((u16)1<<8)
...
// PHANE bits ----------
#define PHANE_r15		((u16)1<<15)
#define PHANE_r14		((u16)1<<14)
#define PHANE_r13		((u16)1<<13)
#define PHANE_r12		((u16)1<<12)
#define PHANE_r11		((u16)1<<11)
#define PHANE_r10		((u16)1<<10)
#define PHANE_r9		((u16)1<<9)
#define PHANE_r8		((u16)1<<8)
#define PHANE_r7		(1<<7)
#define PHANE_r6		(1<<6)
#define PHANE_r5		(1<<5)
...
// PHCON2 bits ---------
#define PHCON2_r15		((u16)1<<15)
#define PHCON2_r14		((u16)1<<14)
#define PHCON2_EDPWRDN	((u16)1<<13)
#define PHCON2_r12		((u16)1<<12)
#define PHCON2_EDTHRES	((u16)1<<11)
#define PHCON2_r10		((u16)1<<10)
#define PHCON2_r9		((u16)1<<9)
#define PHCON2_r8		((u16)1<<8)
...
// PHSTAT2 bits ---------
#define PHSTAT2_r15		((u16)1<<15)
#define PHSTAT2_r14		((u16)1<<14)
#define PHSTAT2_r13		((u16)1<<13)
#define PHSTAT2_r12		((u16)1<<12)
#define PHSTAT2_r11		((u16)1<<11)
#define PHSTAT2_r10		((u16)1<<10)
#define PHSTAT2_r9		((u16)1<<9)
#define PHSTAT2_r8		((u16)1<<8)
...
// PHSTAT3 bits --------
#define PHSTAT3_r15		((u16)1<<15)
#define PHSTAT3_r14		((u16)1<<14)
#define PHSTAT3_r13		((u16)1<<13)
#define PHSTAT3_r12		((u16)1<<12)
#define PHSTAT3_r11		((u16)1<<11)
#define PHSTAT3_r10		((u16)1<<10)
#define PHSTAT3_r9		((u16)1<<9)
#define PHSTAT3_r8		((u16)1<<8)
