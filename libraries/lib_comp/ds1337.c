...
result_t ds1337_init (I2C_BUS i2c_bus_id, u8 dev_addr)
{
    ...
    if (i2c_write_reg(i2c_bus_id, dev_addr, DS1337_REG_CONTROL, 0x10) != SUCCESS)
        return ERROR;
...
result_t ds1337_get_time (I2C_BUS i2c_bus_id, u8 dev_addr, date_time_t *t)
{
    ...
    if (i2c_read_n_reg(i2c_bus_id, dev_addr, DS1337_REG_SEC, sizeof(data), data) != SUCCESS){
        return ERROR;
    }
...
result_t ds1337_set_time (I2C_BUS i2c_bus_id, u8 dev_addr, date_time_t t)
{
    ...
    if (i2c_write_n_reg(i2c_bus_id, dev_addr, DS1337_REG_SEC, sizeof(data), data) != SUCCESS){
        return ERROR;
    }
