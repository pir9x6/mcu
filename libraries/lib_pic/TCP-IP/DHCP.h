...
{
	u8		MessageType;	// Message type for this message
	u8		HardwareType;	// Hardware type for this message
	u8		HardwareLen;	// Length of hardware type
	u8		Hops;			// Number of hops
	u32		TransactionID;	// DHCP Transaction ID
	u16		SecondsElapsed;	// Number of elapsed seconds
	u16		BootpFlags;		// BOOTP Flags
