...
static ROM u8 _MD5_r[64] = {7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,
				  5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,
				  4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,
				  6, 10, 15, 21,  6, 10, 15, 21,  6, 10, 15, 21,  6, 10, 15, 21};

// Array of pre-defined K values for MD5
static ROM u32 _MD5_k[64] = { 0xD76AA478, 0xE8C7B756, 0x242070DB, 0xC1BDCEEE, 0xF57C0FAF, 0x4787C62A, 0xA8304613, 0xFD469501, 
...
static void MD5HashBlock(u8* data, u32* h0, u32* h1, u32* h2, u32* h3);
...
/*****************************************************************************
  Function:
	static void MD5HashBlock(u8* data, u32* h0, u32* h1, 
								u32* h2, u32* h3)
  ...
  Precondition:
	The data pointer must be u16 aligned on 16-bit parts and u32
  ...
  Internal:
  	TODO convert data to a u32* or read from the pointer using byte
...
static void MD5HashBlock(u8* data, u32* h0, u32* h1, u32* h2, u32* h3)
{
	...
	for(i = 0; i < 64u; i++)
	{
		...
		c = b;
		j *= 4;
		b = leftRotateDWORD(a+f+_MD5_k[i]+(*(u32*)&data[j]),_MD5_r[i]) + b;
		a = temp;
	}
...
static void SHA1HashBlock(u8* data, u32* h0, u32* h1, u32* h2, u32* h3, u32* h4);
...
/*****************************************************************************
  Function:
	static void SHA1HashBlock(u8* data, u32* h0, u32* h1, 
								u32* h2, u32* h3, u32* h4)
  ...
  Internal:
  	...
  	accesses only to avoid any accidental alignment errors
  ***************************************************************************/
static void SHA1HashBlock(u8* data, u32* h0, u32* h1, u32* h2, 
							u32* h3, u32* h4)
{
	u32 a, b, c, d, e, f, k, temp;
	DWORD_VAL *w = (DWORD_VAL*)lastBlock;
	u8 i, back3, back8, back14;
