...
static u32 EEPROMAddress;
static u8 EEPROMBuffer[EEPROM_BUFFER_SIZE];
static u8 vBytesInBuffer;
...
/*********************************************************************
 * Function:        XEE_RESULT XEEBeginRead(u32 address)
 *
 * PreCondition:    None
 *
...
/*********************************************************************
 * Function:        XEE_RESULT XEEReadArray(u32 address,
 *                                          u8 *buffer,
 *                                          u16 length)
 *
 ...
 * Note:            None
 ********************************************************************/
XEE_RESULT XEEReadArray(u32 address,
                        u8 *buffer,
                        u16 length)
{
    volatile u8 Dummy;
...
/*********************************************************************
 * Function:        XEE_RESULT XEEBeginWrite(u32 address)
 *
 * PreCondition:    None
 *
...
/*********************************************************************
 * Function:        XEE_RESULT XEEWrite(u8 val)
 *
...
XEE_RESULT XEEWrite(u8 val)
{
	...
	if(vBytesInBuffer >= sizeof(EEPROMBuffer))
		DoWrite();
	else if((((u8)EEPROMAddress + vBytesInBuffer) & (EEPROM_PAGE_SIZE-1)) == 0u)
		DoWrite();
...
/*****************************************************************************
  Function:
    XEE_RESULT XEEWriteArray(u8 *val, u16 wLen)
