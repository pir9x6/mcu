...
/*****************************************************************************
  Function:
    void SPIFlashReadArray(u32 dwAddress, u8 *vData, u16 wLength)
...
void SPIFlashReadArray(u32 dwAddress, u8 *vData, u16 wLength)
{
    ...
    // Send address
    SPIFLASH_SSPBUF = ((u8*)&dwAddress)[2];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwAddress)[1];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwAddress)[0];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;
...
/*****************************************************************************
  Function:
    void SPIFlashBeginWrite(u32 dwAddr)
...
void SPIFlashWrite(u8 vData)
{
    ...
    SPIFLASH_SSPBUF = ((u8*)&dwWriteAddr)[2];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwWriteAddr)[1];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwWriteAddr)[0];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;
...
/*****************************************************************************
  Function:
    void SPIFlashWriteArray(u8* vData, u16 wLen)
...
/*****************************************************************************
  Function:
    void SPIFlashEraseSector(u32 dwAddr)
...
void SPIFlashEraseSector(u32 dwAddr)
{
    ...
    SPIFLASH_SSPBUF = ((u8*)&dwAddr)[2];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwAddr)[1];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;

    SPIFLASH_SSPBUF = ((u8*)&dwAddr)[0];
    WaitForDataByte();
    Dummy = SPIFLASH_SSPBUF;
...
//{
//	volatile u8 Dummy;
//  static u8 statuses[16];
//  static u8 *status = statuses;
//
//  // Activate chip select
//  SPIFLASH_CS_IO = 0;
//  ClearSPIDoneFlag();
