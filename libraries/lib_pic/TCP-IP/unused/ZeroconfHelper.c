...
u8 zeroconf_dbg_level = 3; // All levels of debug info are printed.
...
u8 zgzc_wait_for(u32 *pTicksToWait, u32 *pStartingTickTime, u8 *pWaitingHasStarted)
{
