...
# 2 "<built-in>" 2
# 1 "../../lib_comp/pcf8574.c" 2
# 14 "../../lib_comp/pcf8574.c"
...
void pcf8574_write_port (I2C_BUS i2c_bus_id, u8 adr_chip, u8 data)
{
    ...
    i2c_write(i2c_bus_id, (adr_chip<<1) & 0xFE);
