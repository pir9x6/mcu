...
void main (void)
{
    ...
    pcf8574_write_port(I2C_BUS_1, 0x40 + 0, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x40 + 1, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x40 + 2, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x40 + 3, segments[10]);


    timer2_init( 16, 255);


    pwm_init(PWM_ID_1, 0 , 0 );
    ...
    while (1)
    {
        ...
        dec_2_bcd(t.min, bcd);
        pcf8574_write_port(I2C_BUS_1, 0x40 + 0, segments[bcd[0]]);
        pcf8574_write_port(I2C_BUS_1, 0x40 + 1, segments[bcd[1]]);


        dec_2_bcd(t.hrs, bcd);
        pcf8574_write_port(I2C_BUS_1, 0x40 + 2, segments[bcd[0]]);
        if (bcd[1] == 0)
            pcf8574_write_port(I2C_BUS_1, 0x40 + 3, 0xFF);
        else
            pcf8574_write_port(I2C_BUS_1, 0x40 + 3, segments[bcd[1]]);
    }
}
