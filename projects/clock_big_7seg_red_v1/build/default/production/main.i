...
# 4 "../../lib_comp\\ds1307.h" 2
# 24 "../../lib_comp\\ds1307.h"
...
# 51 "main.c"
date_time_t t;
bool_t time_has_changed = 0;




void __attribute__((picinterrupt(("high_priority")))) timer2_irq()
{
    ...
    {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();};
    {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();};
    {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();}; {__nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop(); __nop();};
    ...
    if (CntTmr2++ == 37)
    {
        ...
        if (time_has_changed){
            time_has_changed = 0;
            ds1307_set_time(I2C_BUS_1, 0x68, t);
        }
    }
...
void main (void)
{
    ...
    i2c_init(I2C_BUS_1, 100000, 0x0001);
    pcf8574_write_port(I2C_BUS_1, 0x20 + 0, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x20 + 1, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x20 + 2, segments[10]);
    pcf8574_write_port(I2C_BUS_1, 0x20 + 3, segments[10]);


    timer2_init( 16, 255);


    pwm_init(PWM_ID_1, 0 , 255 );


    ds1307_init(I2C_BUS_1, 0x68);


    ds1307_get_time(I2C_BUS_1, 0x68, &t);
    ...
    while (1)
    {
        ...
        dec_2_bcd(t.min, bcd);
        pcf8574_write_port(I2C_BUS_1, 0x20 + 0, segments[bcd[0]]);
        pcf8574_write_port(I2C_BUS_1, 0x20 + 1, segments[bcd[1]]);


        dec_2_bcd(t.hrs, bcd);
        pcf8574_write_port(I2C_BUS_1, 0x20 + 2, segments[bcd[0]]);
        if (bcd[1] == 0)
            pcf8574_write_port(I2C_BUS_1, 0x20 + 3, 0xFF);
        else
            pcf8574_write_port(I2C_BUS_1, 0x20 + 3, segments[bcd[1]]);
    }
}
