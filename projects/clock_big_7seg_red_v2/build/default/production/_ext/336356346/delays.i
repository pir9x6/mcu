...
# 2 "<built-in>" 2
# 1 "../../lib_misc/delays.c" 2
# 14 "../../lib_misc/delays.c"
...
# 15 "../../lib_misc/delays.c" 2
# 27 "../../lib_misc/delays.c"
void delay_us (u16 loop)
{
    u16 i, k;
    for (i=loop; i!=0; i--)
        for (k=16000000L/200000000ul; k!=0; k--);
}
