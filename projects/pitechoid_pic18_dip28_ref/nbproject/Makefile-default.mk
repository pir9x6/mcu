...
${OBJECTDIR}/_ext/779364575/ds1621.p1: ../../libraries/lib_comp/ds1621.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/779364575/ds1621.p1.d 
	@${RM} ${OBJECTDIR}/_ext/779364575/ds1621.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"../../libraries/lib_comp" -I"../../libraries/lib_misc" -I"../../libraries/lib_lcd" -I"../../libraries/lib_pic" -I"." -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/_ext/779364575/ds1621.p1 ../../libraries/lib_comp/ds1621.c 
	@-${MV} ${OBJECTDIR}/_ext/779364575/ds1621.d ${OBJECTDIR}/_ext/779364575/ds1621.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/779364575/ds1621.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
